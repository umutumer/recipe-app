...
const RegisterForm = () => {
        ...
        try {
            ...
            if (password === rePassword) {
                ...
                if (response.ok) {
                    ...
                    window.location.href = 'http://localhost:3000/giris-yap'
                    console.log(data);
    ...
    return (
        <div className='register-form-container'>
            <h3 className='register-form-Logo' >PINSOFT RECIPE</h3>
            <form className='register-form'>
                ...
                <input type="file" className="file-input file-input-ghost bg-[#d3d3d3] file-input-xs max-w-xs my-3 md:w-[300px] w-[250px] h-[50px]" onChange={(e) => handleFileChange(e)} />
                <button className='register-form-input' id='register-form-submit' onClick={registerUser} >Kayıt Ol</button>
            </form>
            <Link to={'/giris-yap'} style={{ color: "gray", margin: "10px", textDecoration: "underline" }}>Giriş Yap</Link>
        </div>
    )
}
